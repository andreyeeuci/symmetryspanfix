...
function sym_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSym_trial of sym_trials) {
...
function recallLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisRecall of recall) {
...
function Reset_sequenceRoutineBegin() {
  ...
  for (const thisComponent of Reset_sequenceComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Square_presRoutineBegin() {
  ...
  for (const thisComponent of Square_presComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Sym_trialsRoutineBegin() {
  ...
  for (const thisComponent of Sym_trialsComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Square_recallRoutineBegin() {
  ...
  for (const thisComponent of Square_recallComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
